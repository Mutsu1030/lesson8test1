...
# ←←← ""の2～4行目にRenderのExternal Database URLからコピーしてくる
DATABASE_URL = (
    "postgresql+psycopg2://"
    "recipes_db_h9m9_user:zZPqTUVwBjZf7IyianXZ4VtAXQle7Fam@"
    "dpg-d6gk3vs50q8c73a4v17g-a.oregon-postgres.render.com/"
    "recipes_db_h9m9"
    "?sslmode=require"
)
